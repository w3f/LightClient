...
and $v=n-1=2^{20}-1$ signers. The benchmarks were run on commodity hardware, with an 2.2 GHz i7 and 16GB RAM. Here $v$ is the maximum number of siigners and $n> v$ is the size of a multiplicative subgroup of the field(see Section~\ref{sec:lagrange}).\\
