...
commitments $(i,\mathit{ck}_{i+1})$ and $(i,\mathit{ck}'_{i+1})$, $\mathit{ck}_{i+1} \neq \mathit{ck}'_{i+1}$ and similarly distinct $H_n$ and $H'_n$. If a light client proof
