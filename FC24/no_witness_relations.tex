...
never falls into condition (3) defined in Observation~\ref{obs}, which recursively implies the partial aggregate sum at every step is a well defined curve point, hence, it is a suitable input for the next step; 
...
\noindent Given relations $\Rlacom$ and $\Racom$ described in short in Section~\ref{sec_custom_snarks}, 
