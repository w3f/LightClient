...
\title{Short Paper:\\ Efficient Aggregatable BLS Signatures \\ with Chaum-Pedersen Proofs}
%\author{Web3 Foundation Researchers}
%\author[ ]{Oana Ciobotaru}
%\author[ ]{Alistair Stewart}
%\author[ ]{Sergey Vasilyev}
%\affil[ ]{Web3 Foundation}
...
large distributed system using BLS signatures:  
%
First, public keys should be given on both source groups
