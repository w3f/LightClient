...
\title{Efficient Aggregatable BLS Signatures \\ with Chaum-Pedersen Proofs}
\author{Jeff Burdges \inst{1} \and Oana Ciobotaru \inst{2} \thanks{Research performed while second author worked at Web3 Foundation Technologies.} \and Syed Lavasani \inst{1} \and Alistair Stewart \inst{1}}

\institute{Web3 Foundation Technologies \and OpenZeppelin} 
...
\begin{document}   
 \maketitle
 \noindent
\makebox[\linewidth]{\small 20 September 2023}
