...
\abstract{\color{red} IS ABSTRACT OK?} In this work we revisit the notion of O-SNARKs in relation to a wide class of 
...
we shed more light on the subtleties on where and how O-SNARK security is useful for complex real-world applications.
