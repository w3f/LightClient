...
\noindent{\color{red} TO DO 1 Do we want to add at all this variant? Yes! Is this variant fully correct? Is it as per definition introduced by Dario? 
In fact, eventually, we want the Dario inspired definition to be combined with our light client paper new definition of SNARKs. 
