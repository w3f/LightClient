...
\noindent{\color{red} Next, we introduce the following Lagrange interpolation polynomials of degree at most $n-1 = |H|$ over cyclic group $H$ (Section~\ref{sec:lagrange}): 
...
never falls into condition (3) defined in Observation 1, which recursively implies the partial aggregate sum at every step is a well defined curve point; 
