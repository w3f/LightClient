...
key that they signed on the real chain. {\color{red}Note that the accountability of our light client system instantiation relies on the accountability of the 
...
then the consensus protocol needs to be modified by adding another layer (e.g., BEEFY~\cite{BEEFY}).}
\vspace{-0.05in}.
