...
\begin{dfn}(Consensus view) A consensus view $C$ for a set of epochs with ids $i$, $\forall i \in [k]$, 
...
\begin{dfn}(Valid consensus view)
...
\begin{dfn}(Accountable light client system)  
